			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title text-center p-3">Post A Vehicle</h2>
...
<label for="leatherseats"> Leather Seats </label>
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-2">
													<button class="btn btn-default pt-2" type="reset">Cancel</button>
													<button class="btn btn-primary pt-2" name="submit" type="submit">Save changes</button>
												</div>
											</div>
