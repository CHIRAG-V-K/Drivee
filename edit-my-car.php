...
<a href="change-mycar-img1.php?imgid=<?php echo htmlentities($result->id)?>">Change Image 1</a>
</div>
<div class="col-sm-4">
...
<a href="change-mycar-img2.php?imgid=<?php echo htmlentities($result->id)?>">Change Image 2</a>
</div>
<div class="col-sm-4">
...
<a href="change-mycar-img3.php?imgid=<?php echo htmlentities($result->id)?>">Change Image 3</a>
</div>
</div>
...
<a href="change-mycar-img4.php?imgid=<?php echo htmlentities($result->id)?>">Change Image 4</a>
</div>
<div class="col-sm-4">
Image 5
...
<a href="change-mycar-img5.php?imgid=<?php echo htmlentities($result->id)?>">Change Image 5</a>
<?php } ?>
</div>
